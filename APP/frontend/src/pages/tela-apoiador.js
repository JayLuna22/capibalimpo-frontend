                    ...
                    <div className='box-cadastro'>
                        ...
                        <form id="register-form">
                            <div className="user-box">
                                ...
                                <input className="input-texto" type="text" placeholder="Digite o CNPJ ex: 00.000.000/0001-00" name="cnpj" id="cnpj"
                                    maxLength={18}/>
                                <input className="input-texto" type="email" placeholder="E-mail" name="email" id="email"/>
                                <textarea className="input-msg" placeholder="Conte-nos como seu apoio pode nos ajudar!" name="mensagem" id="mensagem"
                                    maxLength={240}/>
                            ...
                            <div className="btn-cadastro">
                                ...
                                <button type="button" className="botao-submit">
                                    <a href='/'>
                                        <p>Cancelar</p>
                                    </a>
                                </button>
